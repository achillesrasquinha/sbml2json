...
from sbml2json              import __name__ as NAME, __version__
from sbml2json.util.system  import pardir, makedirs, touch
from sbml2json.util.environ import getenv
from sbml2json.util.types   import auto_typecast
from sbml2json.util._dict   import autodict
from sbml2json._compat      import iteritems, configparser as cp
...
def environment():
    ...
    from sbml2json import settings
